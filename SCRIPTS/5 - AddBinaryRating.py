...
Add Binary Ratings in Bechdel Dataset
  Running this script will result in loading a dataset of movies including sentiment scores from IMDb reviews. For further analysis, simplify the 'rating' column into binary classification: 1 for pass (rating == 3), 0 for fail (rating != 3). Additionally, the updated dataset is saved to the same CSV file, 'bechdel_movies.csv'. You can also check the distribution of the new binary 'rating_binary' column
